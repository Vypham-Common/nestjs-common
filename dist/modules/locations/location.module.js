...
exports.LocationModule = LocationModule = __decorate([
    (0, common_1.Module)({
        providers: [location_service_1.LocationService, location_schema_1.LocationModel],
        exports: [location_service_1.LocationService, location_schema_1.LocationModel],
    })
], LocationModule);

...
exports.DepartmentModule = DepartmentModule = __decorate([
    (0, common_1.Module)({
        providers: [department_service_1.DepartmentService, department_schema_1.DepartmentModel],
        exports: [department_service_1.DepartmentService, department_schema_1.DepartmentModel],
    })
], DepartmentModule);
